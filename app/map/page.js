...
const LEGEND=[['cpz','#078d16','CPZ zone'],['paid','#0b73d9','Verified paid bay'],['disabled','#8E44AD','Verified blue badge'],['loading','#ff681f','Verified loading'],['no','#9d9da5','Verified restriction']]
...
export default function MapPage(){
  ...
  return <div className="newham-map-shell"><style jsx global>{`
    ...
    .newham-legend{position:absolute;left:50%;bottom:max(16px,env(safe-area-inset-bottom));transform:translateX(-50%);z-index:300;width:min(620px,calc(100vw - 24px));display:flex;gap:7px;overflow-x:auto;padding:8px;background:rgba(255,255,255,.94);border:1px solid #e7e3f0;border-radius:16px;box-shadow:0 12px 34px rgba(25,20,55,.16);scrollbar-width:none}.newham-legend::-webkit-scrollbar{display:none}.legend-pill{flex:0 0 auto;display:flex;align-items:center;gap:7px;background:#f7f6fc;border-radius:999px;padding:8px 10px;font-size:12px;font-weight:900;color:#3d394f}.legend-pill span{width:14px;height:14px;border-radius:4px;display:block}
